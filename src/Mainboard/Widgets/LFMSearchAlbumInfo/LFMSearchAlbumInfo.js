...
class LFMSearchAlbumInfo extends Component {
	constructor ( props ) {
		super(props);
		this.state = {
		...
		this.urlPart = 'https://ws.audioscrobbler.com/2.0/?method=album.search&album='
    ...
    componentDidMount() {
		...
		FetchData(this.apiUrl).then(res => {
			this.setState({ apiRes: res.results.albummatches.album })
		})
	}
			...
			<div className='ytci'>
				<div className='infoPlaceholder'>
					<div className='youtubeChannelTop'>
						...
						<h2 className='youtubeChannelInfoTitle'>Albums Search</h2>
...
export default LFMSearchAlbumInfo