...
class LFMSearchTrackInfo extends Component {
	constructor ( props ) {
		super(props);
		this.state = {
		...
		this.urlPart = 'https://ws.audioscrobbler.com/2.0/?method=track.search&track='
    ...
    componentDidMount() {
		...
		FetchData(this.apiUrl).then(res => {
			this.setState({ apiRes: res.results.trackmatches.track })
		})
	}
			...
			<div className='ytci'>
				<div className='infoPlaceholder'>
					<div className='youtubeChannelTop'>
						...
						<h2 className='youtubeChannelInfoTitle'>Tracks Search</h2>
				...
				</div>
				{
					...
					<div className='popup'>
						<div className='popupMidification'>
							...
							<input
								type='text'
								placeholder='Example : In the End'
...
export default LFMSearchTrackInfo