...
import LFMArtistInfo from '../../Widgets/LFMArtistInfo/LFMArtistInfo'

import './../WidgetStyle.css'

class LFMArtist extends Component {
	state = {
		genre: '',
		timer: 10
	}
	...
	createWidget = () => {
		...
		let apiUrl = 'https://ws.audioscrobbler.com/2.0/?method=tag.gettopartists&tag=' + this.state.genre + '&api_key=' + apiKey + '&format=json&limit=20'
			...
			<div className='widgetBox'>
				...
				<div className='infoPlaceholder'>
					<div className='topPart'>
						<p className='titleStyle'>Top Artist by genre:</p>
						<div className="widgetTooltip">i
							<span className="widgetTooltiptext">Show the top artists of the genre you choose</span>
						</div>
					</div>
