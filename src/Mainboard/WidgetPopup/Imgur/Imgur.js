...
class Imgur extends Component {
	...
	createWidget = () => {
		...
		let apiUrl = 'https://api.imgur.com/3/gallery/album/' + keyId
			...
			<div className='widgetBox'>
				...
				<div className='infoPlaceholder'>
					<div className='topPart'>
						<p className='titleStyle'>Imgur Album</p>
						<div className="widgetTooltip">i
							<span className="widgetTooltiptext">Show content of a selected album from Imgur</span>
						</div>
					</div>
					<p className='widgetSubtitle'>Album Id : </p>
					<input
						type='text'
