...
import TDValueInfo from './../../Widgets/TDValueInfo/TDValueInfo'

import './../WidgetStyle.css'

class TDValue extends Component {
	state = {
		value: 'AAPL',
		timer: 10
	}
			...
			<div className='widgetBox'>
				...
				<div className='infoPlaceholder'>
					<div className='topPart'>
						<p className='titleStyle'>Action value:</p>
						<div className="widgetTooltip">i
							<span className="widgetTooltiptext">Show the value of an action</span>
						</div>
					</div>
